...
function template_profile_popup()
{
	...
	echo '
			<li><a href="', $scripturl, '?action=profile;u=', $context['user']['id'], '">', $context['member']['avatar']['image'], '</a></li>
			<li><a href="', $scripturl, '?action=profile;u=', $context['user']['id'], '">', $context['user']['name'], '</a></li>
			<li><a id="b_user_grp">', $context['member']['group'], '</a></li>';
	...
	foreach ($context['profile_items'] as $item)
	{
		...
		echo '
			<li><a href="', $item_url, '">', !empty($item['title']) ? $item['title'] : $area['label'], '</a></li>';
	}
}
